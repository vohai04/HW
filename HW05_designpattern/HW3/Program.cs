...
namespace DesignPatterns.Homework
{
    ...
    public class StatisticsDisplay : IWeatherObserver
    {
        ...
        {
            Console.WriteLine("\nStatistics Display:");
            Console.WriteLine($"Max Temperature: {_maxTemp}°C");
            Console.WriteLine($"Min Temperature: {_minTemp}°C");
            Console.WriteLine($"Average Temperature: {(_sumTemp / _numReadings):F1}°C");
        }
    }
    ...
    public class ForecastDisplay : IWeatherObserver
    {
        ...
        public void Display()
        {
            ...
            if (_firstReading)
            {
                forecast = "Initial reading, no forecast available";
            }
